...
{
    public partial class OmsDbContext : IUnitOfWork
    {
        ...
        public OmsDbContext(IRepositoryFactory repositoryFactory, DbContextOptions<OmsDbContext> options, ApplicationContext applicationContext)
            : this(options)
        {
